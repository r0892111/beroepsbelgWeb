...
export function RefinedHero({ locale }: RefinedHeroProps) {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen flex flex-col" style={{ backgroundColor: 'var(--beige-light)' }}>
      <div className="absolute inset-0">
        <Image
          ...
          sizes="100vw"
          quality={95}
          className="object-cover opacity-[0.15] transition-transform duration-1000 ease-out"
          style={{ transform: `scale(${1 + scrollY * 0.0001})` }}
          priority
        />
      </div>
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[var(--beige-light)]" />
