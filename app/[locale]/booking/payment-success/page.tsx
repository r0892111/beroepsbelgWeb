        ...
        <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center px-4 translate-y-1/2 z-20">
          ...
          <div className="bg-white rounded-xl px-8 py-6 shadow-lg">
            ...
            <p className="mt-2 text-lg text-neutral-700 text-center max-w-md">
              {t('description') || 'Thank you for your payment. You will receive a confirmation email shortly.'}
            </p>
          </div>
        </div>
      </div>
        ...
        >
          <CardContent className="p-0">
            ...
            >
              ...
              >
                <MapPin className="h-8 w-8" style={{ color: 'var(--primary-base)' }} />
              </div>
            </div>
            ...
            <div className="px-6 py-6 space-y-4">
              ...
              >
                <p className="text-sm" style={{ color: 'var(--text-primary)' }}>
                  <strong style={{ color: 'var(--primary-dark)' }}>{t('whatsNext') || "What's Next?"}</strong>
                  <br />
                  <span style={{ color: 'var(--text-secondary)' }}>
                    {t('nextSteps') || 'You will receive a confirmation email with all the details of your booking. We look forward to welcoming you!'}
                  </span>
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                <Link href={`/${locale}`}>{t('returnHome') || 'Return Home'}</Link>
              </Button>
              <Button
                asChild
                variant="outline"
